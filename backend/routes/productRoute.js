...
import { listProduct, addProduct, removeProduct, singleProduct, editProduct, updateAllProductStocks, bulkUpdateProducts } from "../controllers/productController.js"
...
productRouter.post('/bulk-update', adminAuth, bulkUpdateProducts);
