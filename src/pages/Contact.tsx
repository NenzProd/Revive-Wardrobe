      ...
      <div className="container mx-auto px-4 py-8 flex-grow">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Have questions about our intimate collections? We're here to help you find the perfect pieces for your wardrobe.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            {contactInfo.map((info, index) => (
              <div key={index} className="bg-gray-50 p-6 rounded-lg shadow-sm text-center">
                ...
                <p className="text-revive-red font-medium mb-1">{info.content}</p>
            ...
            <div className="lg:w-1/3">
              <div className="bg-gray-50 rounded-lg shadow-sm p-6">
                ...
                <div className="space-y-4">
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Shipping & Delivery</h3>
                    <p className="text-gray-600 text-sm">We deliver across India within 3-7 business days. Free shipping on orders above ₹2,000.</p>
                  </div>
                  
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Size Guide</h3>
                    <p className="text-gray-600 text-sm">Check our detailed size guide or contact us for personalized sizing assistance.</p>
                  </div>
                  
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Returns & Exchange</h3>
                    <p className="text-gray-600 text-sm">Easy 15-day return policy for unworn items with original tags and packaging.</p>
                  </div>
                  
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">Custom Stitching</h3>
                    <p className="text-gray-600 text-sm">Our expert tailors can customize any piece to your measurements. Additional charges apply.</p>
                  </div>
                </div>
