  ...
  return (
    <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 group">
      ...
      <div className="p-6">
        ...
        <h3 className="text-xl font-serif mb-3 group-hover:text-revive-red transition-colors">
          {title}
        </h3>
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover style tips, cultural insights, and fashion inspiration to
            help you express your unique identity.
          </p>
        </div>
        ...
        {error && (
          <div className="text-center py-8">
            ...
            <button
              ...
              className="w-full md:w-auto px-6 py-3 bg-revive-red text-white rounded hover:bg-opacity-90 transition-all font-medium"
            >
              Try Again
            </button>
          </div>
        ...
        <div className="text-center mt-12">
          <Link
            to="/blog"
            className="w-full md:w-auto inline-flex items-center justify-center px-6 py-3 bg-revive-red text-white rounded hover:bg-opacity-90 transition-all font-medium"
          >
