        ...
        <div className="px-3 py-4">
          ...
          <div className="relative mb-6">
            ...
            >
              ...
              {/* Min Handle */}
              <div
                className={`absolute w-5 h-5 bg-white border-2 border-amber-500 rounded-full shadow-md cursor-grab transform -translate-y-1.5 transition-all duration-150 hover:scale-110 ${isDragging.min ? 'scale-110 border-amber-600 shadow-lg cursor-grabbing' : ''
                  }`}
                style={{
                  left: `${((priceRange[0] - minRange) / (maxRange - minRange)) * 100}%`,
              ...
              {/* Max Handle */}
              <div
                className={`absolute w-5 h-5 bg-white border-2 border-amber-500 rounded-full shadow-md cursor-grab transform -translate-y-1.5 transition-all duration-150 hover:scale-110 ${isDragging.max ? 'scale-110 border-amber-600 shadow-lg cursor-grabbing' : ''
                  }`}
                style={{
