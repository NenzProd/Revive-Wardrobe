        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">
              Elegance reimagined for the modern woman. Discover timeless
            ...
            <div className="flex space-x-4 mt-6">
              <a
                ...
                aria-label="Facebook"
                className="text-revive-gold hover:text-white transition-colors"
              >
                <Facebook size={20} />
              </a>
              <a
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li>
                <a
                  ...
                  className="hover:text-revive-gold transition-colors"
                >
                  Shipping, Delivery & Payment Policies
                </a>
              </li>
              <li>
                <a
          ...
          <div>
            ...
            <div className="mt-6">
              ...
              <div className="flex space-x-3 items-center payment-icons">
                <img
                  src="/pay_icons/visa_icon.png"
                  alt="Visa"
                  className="h-6"
                />
                <img
                  src="/pay_icons/mastercard_icon.png"
                  alt="MasterCard"
                  className="h-6"
                />
                <img
                  src="/pay_icons/unionPay_icon.png"
                  alt="UnionPay"
                  className="h-6"
                />
                <img
                  src="/pay_icons/american_express.png"
